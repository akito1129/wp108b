const Pos = {
  ...
  <thead>
    <tr>
      ...
      <td>
      <img id="image" src="HoneySelect.png"alt="遊戲照片" >
      </td>
  ...
  Pos.calcPrice = function () {
    ...
    if(a=="HoneySelect:3990"){document.getElementById("image").src = "素材(GamePOS)/HoneySelect.png";}
    if(a=="AI少女:2760"){document.getElementById("image").src = "素材(GamePOS)/AIgirl.png";}
    if(a=="妖花の園:3150"){document.getElementById("image").src = "素材(GamePOS)/DemonFlowerParadise.png";}
    if(a=="Rance10決戰:3380"){document.getElementById("image").src = "素材(GamePOS)/Rance10.png";}
